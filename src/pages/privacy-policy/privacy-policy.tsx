...
export const PrivacyPolicy = () => {
    return (
        <article className="privacy-policy">
            <h1>Privacy Policy for TC-Stenungsund Schedule</h1>

            <p>
                At TC-Stenungsund Schedule, accessible from
                https://klovaaxel.github.io/schedule-react, one of our main
                priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and
                recorded by TC-Stenungsund Schedule and how we use it.
            </p>
            ...
            <p>
                TC-Stenungsund Schedule legal basis for collecting and using the
                personal information described in this Privacy Policy depends on
                the Personal Information we collect and the specific context in
                which we collect the information:
            </p>
            <ul>
                <li>
                    TC-Stenungsund Schedule needs to perform a contract with you
                </li>
                <li>
                    You have given TC-Stenungsund Schedule permission to do so
                </li>
                <li>
                    Processing your personal information is in TC-Stenungsund
                    Schedule legitimate interests
                </li>
                <li>TC-Stenungsund Schedule needs to comply with the law</li>
            </ul>

            <p>
                TC-Stenungsund Schedule will retain your personal information
                only for as long as is necessary for the purposes set out in
                this Privacy Policy. We will retain and use your information to
            ...
            <p>
                TC-Stenungsund Schedule follows a standard procedure of using
            ...
            <p>
                ...
                the advertising partners of TC-Stenungsund Schedule.
            </p>
            ...
            <p>
                ...
                TC-Stenungsund Schedule, which are sent directly to users'
            ...
            <p>
                Note that TC-Stenungsund Schedule has no access to or control
            ...
            <p>
                TC-Stenungsund Schedule's Privacy Policy does not apply to other
            ...
            <p>
                TC-Stenungsund Schedule does not knowingly collect any Personal
            ...
            <p>
                ...
                information that they shared and/or collect in TC-Stenungsund
                Schedule. This policy is not applicable to any information
